...
//Read the command
	...
	if(command === '/CC' || command === '/cc'){
		...
		s = r.result;
		if(s <= 1) res = game.i18n.localize('CoC7.Fumble');
		else if(s >= 100) res= game.i18n.localize('CoC7.CriticalSuccess');
		else if(s >= 100-(m/5)) res= game.i18n.localize('CoC7.ExtremeSuccess');	
		else if(s >= 100-(m/2)) res= game.i18n.localize('CoC7.HardSuccess');	
		else if(s >= m) res= game.i18n.localize('CoC7.RegularSuccess');
		else if(s <= 4){if(m >= 50) res= game.i18n.localize('CoC7.Fumble'); 
	...
	if(command === '/CBR' || command === '/cbr'){
		...
		else if(s >= 100-(n/5)) res += game.i18n.localize('CoC7.ExtremeSuccess');	
		else if(s >= 100-(n/2)) res += game.i18n.localize('CoC7.HardSuccess');	
		else if(s >= n) res += game.i18n.localize('CoC7.RegularSuccess');
		else if(s <= 4){if(n >= 50) res += game.i18n.localize('CoC7.Fumble'); 
		else res += game.i18n.localize('CoC7.Failure');}
		else res += game.i18n.localize('CoC7.Failure');
		//The resulting output.
